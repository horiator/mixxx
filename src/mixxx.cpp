...
/*
    ...
    m_pOptionsKeyboard->setWhatsThis(
...
void MixxxMainWindow::MoveToNewThread(QObject* object, const QString& name) {
...
void MixxxMainWindow::MoveToThread(QObject* object, QThread* thread) {
