...
void LibraryFeatures::bindSidebarWidget(WLibrarySidebar* pSidebarWidget) {
...
void LibraryFeatures::bindWidget(WLibrary* pLibraryWidget,
...
void LibraryFeatures::slotRequestAddDir(QString dir) {
...
void LibraryFeatures::slotRequestRelocateDir(QString oldDir, QString newDir) {
...
QStringList LibraryFeatures::getDirs(){
