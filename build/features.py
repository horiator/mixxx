...
class Clementine(Feature):
    ...
    def configure(self, build, conf):
        ...
        if build.platform_is_linux:
            ...
            build.env.Append(LIBS = 'indicate-qt')
            #build.env.Append(LIBS = 'spotify')
            build.env.Append(LIBS = 'cdio')
            build.env.Append(LIBS = 'qca')
            build.env.Append(LIBS = 'chromaprint_p')
            build.env.Append(LIBS = 'lastfm')
            build.env.Append(LIBS = 'protobuf')
            build.env.Append(LIBS = 'fftw3')
